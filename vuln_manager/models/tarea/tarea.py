...
class Tarea(models.Model):
    ...
    creada_por = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True, related_name='tareas_creadas', verbose_name='Creada por')
...
class EjecucionTarea(models.Model):
    ...
    ejecutada_por = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True, related_name='ejecuciones_tarea', verbose_name='Ejecutada por')
